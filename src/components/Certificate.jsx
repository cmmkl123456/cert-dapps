...
import { formatDate, changeFormatDate } from "utils";
...
const translates = {
  ...
  modeStudy: {
    [STUDY_MODES.fullTime]: {
      en: "Full-time",
      vi: STUDY_MODES.fullTime,
    },
    [STUDY_MODES.partTime]: {
      en: "Part-time",
      vi: STUDY_MODES.partTime,
    },
    [STUDY_MODES.remoteFullTime]: {
      en: "Remote Full-time",
      vi: STUDY_MODES.remoteFullTime,
    },
    [STUDY_MODES.remotePartTime]: {
      en: "Remote Part-time",
      vi: STUDY_MODES.remotePartTime,
    },
  },
};
    ...
    <HStack justify="center" ref={ref}>
      <HStack flex="1" spacing="2" maxW="90em">
        ...
        >
          ...
          <Box textAlign="center" fontWeight="extrabold" fontSize="xl">
          ...
          >
            ...
            <Box borderBottom="1px dotted">
              {changeFormatDate(cert.dateOfBirth)}
            </Box>
